...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Process</h1>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="table-responsive mb-4">
                        <table class="table text-nowrap table-bordered" id="process">
                            <thead>
                                <tr>
                                    <th width="25">#</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body px-4">
                <form id="processForm" name="processForm" class="form-horizontal">
                    @csrf
                    ...
                    <div class="col-xl-12">
                        ...
                        <input type="text" id="processName" name="processName" class="form-control" placeholder="Process Name">
                    </div>                                                                                                                                                                                                                             
                </div>
            </div>
...
<script>
    ...
    $('body').on('click', '.edit', function () {
        var id = $(this).data('id');
            $.get("{{ route('process.index') }}" +'/' + id +'/edit', function (data) {
            $('.error-msg').hide();
            $('#processForm').trigger("reset");
            $('#saveBtn').val("edit");
